...
namespace Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        #region agreement with ui
        protected JsonResult StandardJson()
        {
            return new FormatResult()
            {
                Data = new OperateResult()
                {
                    Success = 1,
                    Message = "执行成功"
                },
        ...
        protected JsonResult StandardJson(string pointMessage)
        {
            return new FormatResult()
            {
                Data = new OperateResult()
        ...
        protected JsonResult StandardJson(object data,int success = 1,string message ="执行成功")
        {
            return new FormatResult()
            {
                Data = new OperateResult ()
